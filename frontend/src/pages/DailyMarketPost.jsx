        ...
        <div className="fixed inset-0 z-[100] flex flex-col bg-white font-sans overflow-hidden">
            ...
            <main className="flex-1 overflow-y-auto p-4 space-y-6">
                ...
                <div className="w-full">
                    <label className="block w-full aspect-video bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl overflow-hidden cursor-pointer active:scale-[0.98] transition-all relative">
