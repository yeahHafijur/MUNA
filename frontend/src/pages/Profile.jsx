...
const IconHelp = () => (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827m0 0v.5m0 2h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);
...
const MenuRow = ({ icon, title, subtitle, onClick, isDanger, isLast, iconBgClass }) => (
    <div
        ...
        className={`flex items-center justify-between p-4 bg-white active:bg-slate-50/80 transition-colors cursor-pointer
...
const Profile = () => {
    ...
    return (
        <div
            className="fixed inset-0 z-[100] flex flex-col bg-[#F8FAFC] overflow-hidden font-sans"
            style={{ paddingTop: 'env(safe-area-inset-top)' }}
        >
            {/* ─── FROSTED NATIVE HEADER ─── */}
            <div className="sticky top-0 z-20 backdrop-blur-xl bg-white/80 border-b border-white/40 shadow-sm">
                <div className="flex items-center justify-between px-4 py-3">
                    ...
                    <span className="text-base font-bold text-slate-900 tracking-tight">Account</span>
                    <div className="w-10" />
                </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto pb-24 scrollbar-hide">
                ...
                <div className="px-4 -mt-16 relative z-10">
                    <div className="bg-white rounded-[32px] p-5 shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-slate-100 flex items-center gap-5">
                        ...
                        <div className="flex flex-col flex-1 min-w-0 justify-center">
                            <h2 className="text-xl font-bold text-slate-900 truncate tracking-tight mb-1">{user.name}</h2>
                            <p className="text-[13px] text-slate-500 font-medium truncate">{user.email}</p>
                            <span className="inline-flex items-center gap-1.5 mt-2 bg-amber-50 border border-amber-100 px-2.5 py-1 rounded-lg text-[11px] font-semibold text-amber-700 w-max tracking-wide">
                ...
                <div className="px-4 space-y-5">
                    ...
                    <div className="bg-white rounded-[28px] shadow-[0_8px_30px_rgba(0,0,0,0.03)] border border-red-50 overflow-hidden">
                        <MenuRow
                            icon={<IconLogout />}
                            title="Sign Out"
                            isDanger
                    ...
                    <div className="text-center pb-8">
                        <p className="text-xs text-slate-400 font-medium tracking-wide">MUNA App v2.0</p>
                    </div>
                </div>
            </div>
        </div>
