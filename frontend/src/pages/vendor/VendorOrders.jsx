                                                        ...
                                                        <td colSpan="6" style={{ padding: '16px', background: 'var(--v-bg-card-hover)' }}>
                                                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    {order.instructions && (
                                                                        <div style={{ background: '#fef9c3', border: '1px solid #fde047', padding: '8px', borderRadius: '6px', fontSize: '12px', color: '#854d0e', marginTop: '8px' }}>
                                                                            <strong style={{ display: 'block', marginBottom: '2px' }}>Customer Instructions:</strong>
                                                                            {order.instructions}
                                                                        </div>
                                                                    )}
